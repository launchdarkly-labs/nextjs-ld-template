...
import HelloRSC from "@/app/components/helloLDRSC";
      ...
      <div className=" grid text-center justify-center items-center">
        <div className="space-y-8">
          ...
          <p className="text-lg font-audimat pb-4 w-2/3 mx-auto">
            ...
            <span className="text-blue-500 font-bold">clientSideFlag</span> with
            the Client-SDK switch enabled, and a boolean standard flag with a
            key of <span className="text-blue-500">serverSideFlag</span> and
            connect your SDK.
          </p>
